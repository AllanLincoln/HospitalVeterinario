...
public class Programa {
    ...
    public static void main(String[] args) {
        ...
        Animal cachorro1;
        cachorro1 = new Animal("Scooby", new Tutor("Salsicha", "132465789"));
        Animal cachorro2;
        cachorro2 = new Animal("Floquinho", new Tutor("Cebolinha", "132465789"));
        Animal gato1;
        gato1 = new Animal("DeBotas",  new Tutor("Shrek", "132465789"));
        Animal gato2;
        gato2 = new Animal("Tom",  new Tutor("Jerry", "132465789"));
        ...
        System.out.println("Registro de atendimento: " + vet1.getNome() + ": " + "Animal: " +  cachorro1.getNome() + " Tutor: " + cachorro1.getTutor().getNome() +  " Modelo de exame: Exame de rotina" );
        System.out.println("========== ========== ========== ========= ========== ========== ========== ==========");
        System.out.println("Registro de atendimento: " + vet2.getNome() + ": " + "Animal: " +  cachorro2.getNome() + " Tutor: " + cachorro2.getTutor().getNome() +  " Modelo de exame: Vacinação anual" );
        System.out.println("========== ========== ========== ========= ========== ========== ========== ==========");
        System.out.println("Registro de atendimento: " + vet1.getNome() + ": " + "Animal: " +  gato1.getNome() + " Tutor: " + gato1.getTutor().getNome() +     " Modelo de exame: Consulta de sintomas" );
        System.out.println("========== ========== ========== ========= ========== ========== ========== ==========");
        System.out.println("Registro de atendimento: " + vet2.getNome() + ": " + "Animal: " +  gato2.getNome() + " Tutor: " + gato2.getTutor().getNome() +     " Modelo de exame: Exame de rotina" );
